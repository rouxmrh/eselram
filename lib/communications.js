...
export async function getBusinessAftercareForService(
  ...
  /*
   * Backward-compatible Eselram starter behaviour:
   * Tattoo Removal, Carbon Facial and Fungal Nail continue to use
   * the exact existing defaults/customisations unless a service-level
   * override is explicitly saved.
   */
  const starter =
    aftercareContentFor(
      serviceName
