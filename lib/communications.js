...
export async function sendPaymentReceipt({
  ...
  if (
    ...
    try {
      ...
      console.error(
        "Unable to create payment receipt manage-booking link:",
        error
      );
    }
  }
  ...
  const html =
    `<!doctype html>
<html>
<body style="margin:0;padding:0;background:#f5f4ef;font-family:Arial,sans-serif;color:#18221f;">
  <div style="max-width:620px;margin:0 auto;padding:28px 18px;">
    <div style="background:#ffffff;border:1px solid rgba(24,34,31,.14);border-radius:18px;padding:30px;">
      ${logoHtml}

      <div style="font-size:12px;font-weight:700;letter-spacing:.12em;color:#365c50;text-transform:uppercase;">
        ...
        manageUrl
          ? `
            <div style="margin-top:24px;">
              <a
                href="${escapeHtml(manageUrl)}"
                style="display:inline-block;background:#365c50;color:#ffffff;text-decoration:none;font-weight:700;padding:12px 18px;border-radius:10px;"
              >
                Manage appointment
              </a>
              ...
              <p style="margin:14px 0 0;font-size:13px;line-height:1.6;color:#66706b;">
                ...
                <a
                  href="${escapeHtml(manageUrl)}"
                  style="color:#365c50;text-decoration:underline;font-weight:600;"
                >
                  click here to manage your appointment
                </a>.
              </p>
    ...
    <p style="margin:14px 0 0;text-align:center;color:#7b837f;font-size:12px;">
      Sent by ${escapeHtml(row.business_name)}
    </p>
  </div>
</body>
</html>`;
