...
export function subscriptionBrokerBase(_request, env) {
  // Subscription management uses the installation's configured Eselram broker.
  // Do not pin installed apps to a version-specific Worker preview URL.
