  ...
  try {
    ...
    if (customerPackageId) {
      ...
      if (
        ...
        return badRequest(
          "Package does not belong to this customer."
        );
      }


      if (
        customerPackage.service_id !==
          serviceId
      ) {
        return badRequest(
          "This package is for a different service."
        );
      }
      ...
      if (
        ...
        return badRequest(
          "This package is not active."
        );
      }


      if (
        customerPackage.expires_on &&
        date >
          customerPackage.expires_on
      ) {
        return badRequest(
          "This package has expired before the selected appointment date."
        );
      }
      ...
      if (
        Number(
          customerPackage.sessions_committed ||
          0
        ) >=
        Number(
          customerPackage.sessions_total ||
          0
        )
      ) {
        return badRequest(
