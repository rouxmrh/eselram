...
/*
 ...
 MIT License.
 Bundled locally into Eselram. No external QR service is used.
*/
...
function localRequire(id) {
  ...
  if (!factory) {
    throw new Error("QR module not found: " + id);
  }
...
function toSvg(
  ...
  var quiet = Number.isFinite(
    Number(options.quiet)
  )
    ? Math.max(
        0,
        Number(options.quiet)
