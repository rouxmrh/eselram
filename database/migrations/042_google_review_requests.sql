-- Eselram
-- Migration: 042_google_review_requests.sql
-- Adds optional Google review request communications.
...
INSERT OR IGNORE INTO schema_migrations (version) VALUES ('042_google_review_requests');
